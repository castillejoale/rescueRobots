...
if("TRUE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /home/cc/ee106a/fa15/class/ee106a-bv/project/src/project)
  set(project_DEVEL_PREFIX /home/cc/ee106a/fa15/class/ee106a-bv/project/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /home/cc/ee106a/fa15/class/ee106a-bv/project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-bv <ee106a-bv@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa15/class/ee106a-bv/project/src/project/${idir}'.  Ask the maintainer 'ee106a-bv <ee106a-bv@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa15/class/ee106a-bv/project/devel/lib;/home/cc/ee106a/fa15/class/ee106a-bv/ros_workspaces/lab6/devel/lib;/opt/ros/indigo/lib)
